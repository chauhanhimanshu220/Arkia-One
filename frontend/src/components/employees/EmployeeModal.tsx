  ...
  useEffect(() => {
    if (employee) {
      setForm({
        ...
        department: employee.department || (fixedRole === "System Admin" ? "IT & Administration" : ""),
        designation: employee.designation || (fixedRole === "System Admin" ? "System Administrator" : ""),
        reportingManagerId: employee.reportingManagerId,
        businessUnit: employee.businessUnit || (fixedRole === "System Admin" ? (employees[0]?.businessUnit || "IT & Administration") : ""),
    ...
    setForm({
      ...
      profilePhotoDataUrl: initialProfilePhoto,
      department: fixedRole === "System Admin" ? "IT & Administration" : "",
      designation: fixedRole === "System Admin" ? "System Administrator" : "",
      businessUnit: fixedRole === "System Admin" ? (employees[0]?.businessUnit || "IT & Administration") : "",
      workLocation: "Office",
    });
    setGeneratedPassword(createGeneratedPassword());
    setManualPassword("");
